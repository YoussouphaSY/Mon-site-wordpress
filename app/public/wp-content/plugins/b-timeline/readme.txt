...
Easily display your memories or stories on the web.
...
1. Go to -> B Timeline from the Dashboard menu -> Add New.
2. Configure the B Timeline Options according to your preferences.
3. Copy the Generated ShortCode form that screen and use in your desired post, page and widgets. 
...
1. Sidebar / Dashbord menu
2. Add New Timeline
3. Shortcode / Timeline configuration 
4. Demo 1
5. Demo 2
6. Demo 3
7. Demo 4
...
= 1.0.3 =
* solved horizontal issue

= 1.0.2 =
* Fixed Visible items issue
