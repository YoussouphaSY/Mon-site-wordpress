...
(function( $ ) {
	...
	*/
		...
		function football_sports_club_customizer_label( id, title ) {
			...
			if ( id === 'football_sports_club_woocommerce_product_sale' ) {
				$( '#customize-control-'+ id ).before('<li class="tab-title customize-control">'+ title  +'</li>');
			} else {
				$( '#customize-control-football_sports_club_options-'+ id ).before('<li class="tab-title customize-control">'+ title +'</li>');
			}
			...
			if ( id === 'football_sports_club_footer_bg_image' ) {
				$( '#customize-control-'+ id ).before('<li class="tab-title customize-control">'+ title  +'</li>');
			} else {
				$( '#customize-control-football_sports_club_options-'+ id ).before('<li class="tab-title customize-control">'+ title +'</li>');
			}
	...
	*/
		...
		//Footer
		football_sports_club_customizer_label( 'football_sports_club_footer_bg_image', 'Footer' );
