        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-5 col-sm-5 align-self-center text-center text-md-right">
                ...
                <?php if(get_theme_mod('football_sports_club_phone') != ''){ ?>
                    <span><i class="fas fa-phone mr-2"></i><a href="tel:<?php echo esc_html(get_theme_mod('football_sports_club_phone','')); ?>"><?php echo esc_html(get_theme_mod('football_sports_club_phone','')); ?></a></span>
                <?php }?>
            </div>
