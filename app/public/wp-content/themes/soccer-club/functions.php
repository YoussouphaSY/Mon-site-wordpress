...
function soccer_club_admin_notice() {
    ...
    if (!$dismissed) {
        ...
        <div class="updated notice notice-success is-dismissible notice-get-started-class" data-notice="get-start" style="display: flex;padding: 10px;">
            <p><?php echo esc_html('Initiate your theme exploration by clicking on the "Getting Started" Button.', 'soccer-club'); ?></p>
            <a style="margin-left: 30px;" class="button button-primary"
               href="<?php echo esc_url(admin_url('themes.php?page=soccer-club')); ?>"><?php esc_html_e('Getting Started', 'soccer-club') ?></a>
        </div>
        <?php
    }
}
