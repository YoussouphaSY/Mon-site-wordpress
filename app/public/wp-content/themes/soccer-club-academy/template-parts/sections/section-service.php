		...
		<div class="row justify-content-center text-center">
			<div class="col-md-10 col-lg-8">
				<div class="header-section">
					<h2 class="title"><?php esc_html_e( 'Our Feature', 'soccer-club-academy' ); ?></h2>
					<!-- <p class="description"><?php esc_html_e( 'Sed at blandit ante. Vivamus feugiat lacus eusus cipit attis, tortor mi aliquam.', 'soccer-club-academy' ); ?></p>					 -->
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-4 col-sm-6 col-xs-12">
				...
				<div class="leftside">
			        ...
			        ?>
			        <?php 
						$icon = get_theme_mod('service_icon'.$p,'fa fa-trophy');
			        ?>
					...
					<div class="box-space">
						...
						<div class="single-service">
							<div class="row">
									<div class="col-lg-4 col-md-4 col-xs-4 part-padding">
										<div class="part-1">
											<div class="iconBox">
												<div class="imageBox">
									...
									<div class="col-lg-8 col-md-8 col-xs-8">
										<div class="part-2">
											...
											<!-- <a href="<?php echo esc_url( get_permalink() ); ?>"><?php esc_html_e( 'READ MORE', 'soccer-club-academy' ); ?></a> -->
										</div>
									</div>
								</div>
			...
			<div class="col-md-4 col-sm-6 col-xs-12">
				<div class="imgserviceslider">
					...
					<?php 
			              $center_image = get_theme_mod('center_image');
			              if(!empty($center_image)){
			                echo '<img alt="'. esc_html(get_the_title()) .'" src="'.esc_url($center_image).'" class="img-responsive secondry-bg-img" />';
			              }else{
			                echo '<img alt="sign" src="'.get_template_directory_uri().'/assets/images/service_center.jpg"  />';
			              }	
		          	?>
				</div>
			</div>
