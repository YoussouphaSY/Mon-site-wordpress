 ...
 */
function soccerclubacademy_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function soccerclubacademy_sanitize_hex_color( $hex_color, $setting ) {
...
function soccerclubacademy_switch_sanitization( $input ) {
    if ( true === $input ) {
        return 1;
    } else {
        return 0;
...
function soccerclubacademy_sanitize_choices( $input, $setting ) {
    global $wp_customize; 
...
function soccerclubacademy_sanitize_float( $input ) {
 ...
 */
function soccerclubacademy_sanitize_html( $html ) {
 ...
 */
function soccerclubacademy_sanitize_image( $image, $setting ) {
 ...
 */
function soccerclubacademy_sanitize_nohtml( $nohtml ) {
 ...
 */
function soccerclubacademy_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function soccerclubacademy_sanitize_range_value( $number, $setting ) {
 ...
 */
function soccerclubacademy_sanitize_select( $input, $setting ) {
 ...
 */
function soccerclubacademy_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function soccerclubacademy_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function soccerclubacademy_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}
