!function(t){var n={};function e(i){if(n[i])return n[i].exports;var o=n[i]={i:i,l:!1,exports:{}};return t[i].call(o.exports,o,o.exports,e),o.l=!0,o.exports}e.m=t,e.c=n,e.d=function(t,n,i){e.o(t,n)||Object.defineProperty(t,n,{enumerable:!0,get:i})},e.r=function(t){"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(t,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(t,"__esModule",{value:!0})},e.t=function(t,n){if(1&n&&(t=e(t)),8&n)return t;if(4&n&&"object"==typeof t&&t&&t.__esModule)return t;var i=Object.create(null);if(e.r(i),Object.defineProperty(i,"default",{enumerable:!0,value:t}),2&n&&"string"!=typeof t)for(var o in t)e.d(i,o,function(n){return t[n]}.bind(null,o));return i},e.n=function(t){var n=t&&t.__esModule?function(){return t.default}:function(){return t};return e.d(n,"a",n),n},e.o=function(t,n){return Object.prototype.hasOwnProperty.call(t,n)},e.p="/",e(e.s=0)}({"//zx":function(t,n){},0:function(t,n,e){e("H0l3"),t.exports=e("//zx")},Asnn:function(t,n){wp.customize.sectionConstructor["wptrt-button"]=wp.customize.Section.extend({attachEvents:function(){},isContextuallyActive:function(){return!0}})},H0l3:function(t,n,e){"use strict";e.r(n),e("Asnn")}}),jQuery(document).ready(function(t){t("body").on("click",".soccerclubacademy-icon-list li",function(){var n=t(this).find("i").attr("class");t(this).addClass("icon-active").siblings().removeClass("icon-active"),t(this).parent(".soccerclubacademy-icon-list").prev(".soccerclubacademy-selected-icon").children("i").attr("class","").addClass(n),t(this).parent(".soccerclubacademy-icon-list").next("input").val(n).trigger("change")}),t("body").on("click",".soccerclubacademy-selected-icon",function(){t(this).next().slideToggle()})});
  
( function( $ ) {
  var this_obj = soccerclubacademy_customizer_params;
  ...
  api.bind( 'pane-contents-reflowed', function() {
    ...
    api.section.each( function( section ) {
      ...
      if (
        'soccerclubacademy_section' !== section.params.type ||
    ...
    api.panel.each( function( panel ) {
      ...
      if (
        'soccerclubacademy_panel' !== panel.params.type ||
  ...
  wp.customize.Panel = wp.customize.Panel.extend({
    attachEvents: function() {
      ...
      if (
        'soccerclubacademy_panel' !== this.params.type ||
  ...
  wp.customize.Section = wp.customize.Section.extend({
    attachEvents: function() {
      if (
        'soccerclubacademy_section' !== this.params.type ||
...
(function (api) {
  ...
  api.Tab = api.Control.extend({
    ready: function () {
      var control = this;
      control.container.find('a.soccerclubacademy-customizer-tab').click(function (evt) {
        var tab = jQuery(this).data('tab');
        evt.preventDefault();
        control.container.find('a.soccerclubacademy-customizer-tab').removeClass('active');
...
jQuery( document ).ready(function($) {
  ...
  $('.refresh-btn').on('click', function() {
    ...
    $.get( soccerclubacademy_customizer_params.ajaxurl + '?action=' + dataValue, function( data ) {
